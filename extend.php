...
// Flarum 1.x: forum bundle uses webpack runtime that expects flarum.reg._webpack_runtimes (2.0). Polyfill so it runs first.
$forumFrontend->content(function (\Flarum\Frontend\Document $document) {
    $script = '<script>(function(){'
        ...
        . '})();</script>';
    array_unshift($document->head, $script);
});
